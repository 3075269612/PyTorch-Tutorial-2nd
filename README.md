> **[✨ Naato's Fork 优化说明]**
> 本仓库基于原版《PyTorch实用教程》（第二版）进行了**云端工程化适配**，主打“开箱即用”，零基础/免配置即可跑通所有项目：
> 
> * 📦 **自带训练样本**：数据集已完整嵌入，克隆后无需额外寻找和下载数据。
> * 🔗 **重构路径依赖**：全面修复并统一了原版中的绝对/相对文件路径（`unify sample path`），避免跨平台运行时的路径报错。
> * ☁️ **云端完美运行**：深度适配 Google Colab 等云端算力平台，一键运行各章核心实战代码。
>
> *(注：以下为原作者的原始教程介绍)*
---
...
- [PyTorch 实用教程（第二版）](#pytorch-实用教程第二版)
- [目录](#目录)
- [本书内容](#本书内容)
  - [上篇](#上篇)
  - [中篇](#中篇)
